...
//void CQuad::initialise(const char* file, int _x, int _y, float _scale)
//{
//	// load in the program
//	m_program = ShaderLoader::CreateProgram("Resources/Shaders/simple.verts",
//		"Resources/Shaders/simple.frags");
//
//	m_posX = (float)_x;
//	m_posY = (float)_y;
//	m_posZ = 0.0f;
...
void CQuad::initialise(GLuint _program, GLuint _texture, float _x, float _y, float _scale)
{
	// load in the program
	m_program = _program;
	m_tex = _texture;
...
void CQuad::Render(CCamera* _gameCam)
{
