...
CReflectiveSphere::CReflectiveSphere()
{
}
...
void CReflectiveSphere::initialise(GLuint _program, GLuint _texture, float _x, float _y, float _scale)
{
...
//void CReflectiveSphere::initialise(const char * file, int _x, int _y, float _scale)
//{
//	// load in the program
//	m_program = ShaderLoader::CreateProgram("Resources/Shaders/reflectiveSphere.verts",
//		"Resources/Shaders/reflectiveSphere.frags");
//
//	m_posX = (float)_x;
//	m_posY = (float)_y;
//	m_posZ = 0.0f;
...
void CReflectiveSphere::Render(CCamera * _gameCam, unsigned int _skyboxTexID)
{
	...
	glBindTexture(GL_TEXTURE_CUBE_MAP, _skyboxTexID);
