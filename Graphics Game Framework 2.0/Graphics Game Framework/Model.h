...
public:
	...
	Model(std::string path, CCamera* camera){
		...
		// EDIT
		this->program = ShaderLoader::CreateProgram("Resources/Shaders/Model.verts", "Resources/Shaders/Model.frags");
		// EDIT END
	...
	void Render(glm::vec3 _objPosition, float _objAngle, glm::vec3 _objScale)
	{
		for (GLuint i = 0; i < this->meshes.size(); i++) {

		//printf("mesh size: %d \n", meshes.size());

			this->meshes[i].Render(camera, program, _objPosition, _objAngle, _objScale);
		}
	}
